...
while True:
    ...
    if deteccion is not None:
        ...
        led1 = PLC.read_coils(1, 1, slave=1).bits[0]
        cliente.publish("Ledautom1", led1)
        led2 = PLC.read_coils(2, 1, slave=1).bits[0]
        cliente.publish("Ledautom2", led2)
        led3 = PLC.read_coils(3, 1, slave=1).bits[0]
        cliente.publish("Ledautom3", led3)
        led4 = PLC.read_coils(4, 1, slave=1).bits[0]
        cliente.publish("Ledautom4", led4)
